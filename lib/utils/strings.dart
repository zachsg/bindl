...
const educationHeaderLabel = 'Automagical Meal Planning';
const educationBodyLabel =
    'Your meal plan is generated by Bodai\'s Meal Prediction Engine (MPE). It learns your palate as you use the app and picks meals tailored to you. Remember those left & right swipes? Those mattered. The allergies and prefs you set? Those too. And every meal you cook + rate moving forward will train it too. Let the cooking & learning begin! (Both yours and the MPE\'s 🥳)';
