...
final myLikedPostsProvider =
    StateNotifierProvider<MyLikedPostsController, List<Post>>(
        (ref) => MyLikedPostsController(ref: ref));

class MyLikedPostsController extends StateNotifier<List<Post>> {
  MyLikedPostsController({required this.ref}) : super([]);
  ...
  Future<bool> load() async {
    ...
    posts.removeWhere(
        (element) => !element.likes.contains(supabase.auth.currentUser!.id));
